        ...
        <div className={style.quoteRangeList}>
          {memoFakeApi
            ...
            .map((item, index) => {
              ...
              const confirmEdit = () => {
                setEditableId(-1);
                memoFakeApi.put(id, { prodClass, doorType, content: tempMemo });
              ...
              return (
                <CellWithBar className={style.row} key={index} isActive={idEditable}>
                  ...
                  <div className={style.icon}>
                    {idEditable ? <IconCheck02 onClick={confirmEdit} /> : <IconEdit onClick={toEdit} />}
                  </div>
                  <div className={style.icon}>
