...
import scss from './importAttendance.module.scss';
...
export default function BusinessTrip() {
  ...
  const columns: ColumnsType<ReportItem> = [
    { title: '上傳人員', dataIndex: 'uploader', key: 'uploader', align: 'left', width: '10%' },
    { title: '上傳日期', dataIndex: 'uploadDate', key: 'uploadDate', align: 'left', width: '15%' },
    { title: '報表名稱', dataIndex: 'reportName', key: 'reportName', align: 'left', width: '10%' },
    { title: '日期範圍', dataIndex: 'dateRange', key: 'dateRange', align: 'left', width: '35%' },
    { title: '異常筆數', dataIndex: 'errorCount', key: 'errorCount', align: 'center', width: '10%' },
    ...
    <>
      <div className="border border-[#616161] rounded-md px-6 py-8 h-full">
        <div className="flex items-center justify-between mb-6">
          ...
          <AddButton label="上傳檔案" onClick={() => setIsModalOpen(true)} className="h-[40px]" />
        </div>
