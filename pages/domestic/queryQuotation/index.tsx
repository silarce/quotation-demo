...
export default function Budget() {
  ...
  const searchGroup: TsearchGroup = useSearchGroup({ contactPerson });
...
// MARK:useSearchGroup
const useSearchGroup = ({ contactPerson }: { contactPerson: string | undefined }) => {
  const router = useRouter();
...
const usePanelArr = ({
  ...
  quotationPathList: ReturnType<typeof useGlobal_optionalConfig>['quotationPathList'];
    ...
    pageArr.forEach((key, pageIndex) => {
      ...
      arr.forEach((quotation, index) => {
        ...
        const header: Tcontrol_queryQuotationList['panelArr'][number]['header'] = {
          ...
          quoteDate: getTaiwanDateStr(latestContent.quotationDate),
