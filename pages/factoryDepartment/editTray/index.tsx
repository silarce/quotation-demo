...
import { JSXElementConstructor, Key, ReactElement, ReactFragment, ReactPortal, useContext, useEffect, useMemo, useRef, useState } from 'react';
...
export default function EditTray() {
    ...
    //取得子儲格的layout
    const getLaychildOutBywhpositin = async (length: any, width: any, childlength: any, childwidth: any, maxchildlength: any) => {
    ...
    return (
        ...
        <SubLayer isLoading_subLayer={false} className='overflow-hidden'>
            <PageHeader02 tag={`修改｜倉庫編號：${whname}｜托盤編號：${trayname}`} panelList={undefined}
                customeRight={[
                    <>
                        {/* <button
                ...
                <div className={scss.right}>
                    <div className={scss.content}>
                        <div className={scss.head_body}>
                            ...
                            <div className={scss.head_content0} style={{ display: `${childwhposition === null ? 'none' : ''}`, padding: '39px 0px' }}>
