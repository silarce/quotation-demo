...
export default function PRequisitionDetail() {
  ...
  const { firstin, item, viewtype } = router.query;
  ...
  const Add = async () => {
    ...
    try {
      ...
      const conditionModel = {
        ...
        need_date: dayjs().format('YYYY-MM-DD') || '',
                ...
                <div className={scss.head_content1}>
                  ...
                  <div>
                    ...
                    <InputSel
                      ...
                      datePickerProps={{
                        props: {
                          value: need_datein ? dayjs(need_datein) : null,
                          onChange: (e) => {
                            setNeed_datein(e ? dayjs(e).format('YYYY-MM-DDTHH:mm:ssZ') : '');
                          },
                        },
                      }}
                    />
                        ...
                        <div className={scss.row01}>
                          ...
                          <span>
                            <input
                              ...
                              readOnly={true}
                              onChange={(e) => {
                                handleStringChange(index, 'po_quantity', e.target.value);
