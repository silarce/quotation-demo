...
export default function AddPurchaseRequisition() {
  ...
  const { firstin, purchaseorderuuid, create_at, create_by, purchaseorderdetailuuid } = router.query;
  ...
  const AddPurchaseRequisition = async () => {
    ...
    try {
      ...
      const conditionModel = {
        ...
        need_date: dayjs(need_date).format('YYYY-MM-DD'),
  ...
  const filterData = () => {
    ...
    // 模糊查詢請購單號
    if (requisitionId) {
      filteredData = filteredData.filter((item) => item.purchaserequisitionid.toString().includes(requisitionId));
    }
          ...
          <div className={scss.content}>
            <div className={scss.head_head1}>
              ...
              <div>
                ...
                >
                  <img
                    src={status === '未儲存' ? icon_cancel.src : icon_cancel_gray.src}
                    alt="search"
                    style={{ height: '20px', width: '20px' }}
                  />
                  取消
              ...
              <div>
                <button
                  ...
                  onClick={() => {
                    handleDeletePR(purchaserequisitionuuid);
                  }}
                  title="單據刪除"
                >
            ...
            <div className={scss.body_content1} style={{ overflowX: 'auto' }}>
              ...
              <div
                ...
                style={{
                  display: `${purchaserequisitionid != '' && status === '未送出' ? '' : 'none'}`,
