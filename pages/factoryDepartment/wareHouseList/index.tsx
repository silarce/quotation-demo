...
export default function WareHouseList() {
  ...
  return (
    <SubLayer isLoading_subLayer={isLoading}>
      <PageHeader02 tag={quotationStatusLookup[status] ?? '倉庫'} panelList={panelList} customeLeft={[]} />
      <div>
              ...
              <CellWithBar key={index} className={scss.panelHeader}>
                ...
                >
                  ...
                  <span>
                    <IconDetail
                      onClick={() =>
                        getTrayByWareHouse(_item, traycalled, traycalledname, traytransfer, url, whnamecalled)
                      }
                    />
                  </span>
                  <span></span>
