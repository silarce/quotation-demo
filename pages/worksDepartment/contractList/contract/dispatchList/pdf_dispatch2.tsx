        ...
        >
          ...
          <div className={classNames(scss.top)}>
            ...
            <div className={classNames('pb-[4px] w-full')}>
              <div className={classNames('border-b-2 border-border02')}>{'　'}</div>
            </div>
          </div>
          ...
          <div className={classNames(scss.table)}>
            ...
            <Cell className={classNames('col-span-3 row-span-2')}></Cell>
            <Cell className={classNames('row-span-2', cn2)}>電話</Cell>
            <Cell className={classNames('col-span-2 row-span-2')}></Cell>
            ...
            <Cell className={classNames('col-span-3')}></Cell>
            <Cell className={classNames(cn2)}>住址</Cell>
            <Cell className={classNames('col-span-5')}></Cell>
            {/* row4 */}
            ...
            <Cell className={classNames('col-span-8 row-span-8')}></Cell>
            <Cell className={classNames('col-span-2 gap-6', cn2)}>{strToSpan('派工批價')}</Cell>
            {/* row7 */}
            <Cell></Cell>
            <Cell>合約內</Cell>
            {/* row8 */}
            ...
            <Cell>其他</Cell>
            {/* row13 */}
            <Cell className={classNames(cn2)}>金額</Cell>
            <Cell></Cell>
            {/* row14 */}
...
const cn1 = 'flex justify-between items-center px-3';
const cn2 = 'flex justify-center items-center';
const cn3 = 'flex items-center';
const cn4 = 'text-center leading-9';
