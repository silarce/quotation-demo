  ...
  return (
    <SubLayer isLoading_subLayer={isLoading}>
      ...
      <PageHeader02
        ...
        panelList={undefined}
        customeRight={[
          <div key="0" style={{ display: `${viewtype === 'review' ? 'none' : ''}` }}>
              ...
              {data &&
                data.map((_item: any, index: number) => {
                  ...
                  const deduction_total =
                    ...
                    parseFloat(_item.leave_day_pay || 0) +
                    parseFloat(_item.self_contributed_retirement_fund || 0);
                  ...
                  return (
                    <CellWithBar key={index} className={scss.panelHeader1}>
                      ...
                      >
                        ...
                        <span>{_item.leave_day || 0}</span>
                        <span>{editall === true ? _item.salary : Number(_item.salary).toLocaleString()}</span>
                        <span>
                          <input
                        ...
                        <span>
                          {editall === true ? _item.actual_salary : Number(_item.actual_salary).toLocaleString()}
                        </span>
                        <span>
                          <input
                        ...
                        <span>
                          <input
                            ...
                            value={
                              editall
                                ? _item.perfect_attendance_bonus
                                : Number(_item.perfect_attendance_bonus).toLocaleString()
                            }
                            onChange={(e) => {
                              const newData = [...data];
                              ...
                              newData[index] = {
                                ...newData[index],
                                perfect_attendance_bonus: editall
                                  ? newPerfect_attendance_bonus
                                  : parseFloat(newPerfect_attendance_bonus.replace(/,/g, '')),
                              };
                              setData(newData);
                            }}
                          />
                        ...
                        <span>
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              newData[index] = {
                                ...newData[index],
                                leave_day_pay: editall
                                  ? newLeave_day_pay
                                  : parseFloat(newLeave_day_pay.replace(/,/g, '')),
                              };
                              setData(newData);
                            }}
                          />
                        ...
                        <span>
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              newData[index] = {
                                ...newData[index],
                                advance_payment: editall
                                  ? newAdvance_payment
                                  : parseFloat(newAdvance_payment.replace(/,/g, '')),
                              };
                              setData(newData);
                            }}
                          />
                        ...
                        <span>
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              newData[index] = {
                                ...newData[index],
                                income_tax_people: editall
                                  ? newIncome_tax_people
                                  : parseFloat(newIncome_tax_people.replace(/,/g, '')),
                              };
                              setData(newData);
                            }}
                          />
                        ...
                        <span>
                          <input
                            ...
                            type={editall ? 'number' : 'text'}
                            value={
                              editall ? _item.labor_insurance_fee : Number(_item.labor_insurance_fee).toLocaleString()
                            }
                            onChange={(e) => {
                              const newData = [...data];
                              ...
                              newData[index] = {
                                ...newData[index],
                                labor_insurance_fee: editall
                                  ? newLabor_insurance_fee
                                  : parseFloat(newLabor_insurance_fee.replace(/,/g, '')),
                              };
                              setData(newData);
                            }}
                          />
                        ...
                        <span>
                          <input
                            ...
                            type={editall ? 'number' : 'text'}
                            value={
                              editall ? _item.health_insurance_fee : Number(_item.health_insurance_fee).toLocaleString()
                            }
                            onChange={(e) => {
                              const newData = [...data];
                              ...
                              newData[index] = {
                                ...newData[index],
                                health_insurance_fee: editall
                                  ? newHealth_insurance_fee
                                  : parseFloat(newHealth_insurance_fee.replace(/,/g, '')),
                              };
                              setData(newData);
                            }}
                          />
                        ...
                        <span>
                          <input
                            ...
                            value={
                              editall
                                ? _item.health_insurance_people
                                : Number(_item.health_insurance_people).toLocaleString()
                            }
                            onChange={(e) => {
                              const newData = [...data];
                              ...
                              newData[index] = {
                                ...newData[index],
                                health_insurance_people: editall
                                  ? newHealth_insurance_people
                                  : parseFloat(newHealth_insurance_people.replace(/,/g, '')),
                              };
                              setData(newData);
                            }}
                          />
                        ...
                        <span>
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              newData[index] = {
                                ...newData[index],
                                late_deduction: editall
                                  ? newLate_deduction
                                  : parseFloat(newLate_deduction.replace(/,/g, '')),
                              };
                              setData(newData);
                            }}
                          />
                        ...
                        <span>
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              newData[index] = {
                                ...newData[index],
                                self_contributed_retirement_fund: editall
                                  ? newSelf_contributed_retirement_funde
                                  : parseFloat(newSelf_contributed_retirement_funde.replace(/,/g, '')),
                              };
                              setData(newData);
                            }}
                          />
                        </span>
                        <span>{_item.deduction_total.toLocaleString()}</span>
                        <span>{_item.net_pay.toLocaleString()}</span>
                      </div>
                    </CellWithBar>
                  );
                })}
