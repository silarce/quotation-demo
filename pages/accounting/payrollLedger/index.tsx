                  ...
                  return (
                    <CellWithBar key={index} className={scss.panelHeader1}>
                      <div className={scss.row01}>
                        ...
                        <span>{Number(_item.salary).toLocaleString()}</span>
                        <span>
                          <input
                        ...
                        <span>{Number(_item.supplement).toLocaleString()}</span>
                        <span>{Number(_item.allowance).toLocaleString()}</span>
                        <span>
                          <input
                        ...
                        <span>{Number(_item.overtime_pay).toLocaleString()}</span>
                        ...
                        <span>{Number(_item.advance_payment).toLocaleString()}</span>
                        <span>{Number(_item.income_tax).toLocaleString()}</span>
                        <span>
                          <input
