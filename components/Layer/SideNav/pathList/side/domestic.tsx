...
const inProd = process.env.NEXT_PUBLIC_NODE_ENV === 'prod';

export default function SidePathSalesDepartmentDomestic() {
  const { legacyContractIntegration, domestic, statisticsTable, accountsReceivable } = erpFeaturesLookup;
      ...
      list: [
        {
          ...
          list: [
            ...
            {
              label: '追加減報價單',
              path: path + '/attachQuotationList',
              erpFeature: inProd ? [] : 'allPass',
            },
