import { ChangeEvent, TextareaHTMLAttributes, CSSProperties, FocusEvent, Dispatch, SetStateAction } from 'react';
...
export default function Textarea({
  ...
  const { value, onChange, className, allowNewLineByUser, props } = textareaProps;
