...
export default function CheckButton({
  ...
  if (value) {
    label = value ? checkLabel : uncheckLable;
  } else {
    label = isCheck ? checkLabel : uncheckLable;
  }

  return (
    <button className={classNames(scss.button, px && scss[px], className)} onClick={theOnClick}>
