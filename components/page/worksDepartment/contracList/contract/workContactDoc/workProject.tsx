...
export default function WorkProject() {
  ...
  return (
    <div className={style.workProject}>
      ...
      <div>
        <Table01<TFakeDatakeyIndexN, TFakeDatakeyIndexI>
          tableData={fakeData}
          keyIndex={keyIndex}
        />
      </div>
...
type TFakeDatakeyIndexN =
  keyof Pick<TdndCellConfig,
    "project" | "L" | "H" | "B" | "doorType" | "material" |
    "thickness" | "surface" | "openType" | "horsepower" | "qty" |
    "memo">

type TFakeDatakeyIndexI =
  keyof Pick<TdndCellConfig, "doorRail">
...
const keyIndex: TkeyIndex = [
  "project", "L", "H", "B", "doorType", "material",
  "thickness", "surface", "doorRail", "openType", "horsepower", "qty",
  "memo"
]
