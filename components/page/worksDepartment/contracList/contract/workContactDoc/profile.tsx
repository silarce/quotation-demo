    ...
    <div className={style.profile}>
      ...
      <div className={style.leftBlock}>
        ...
        <div className={style.leftDownBlock}>
          <InputSel
            label="工程電話"
            inputProps={{ value: "04-1234567" }}
            {...inputStyle01} />
          <InputSel
            label="工程負責人"
            inputProps={{ value: "王先生" }}
            {...inputStyle02} />
          <InputSel
            label="工程傳真"
            inputProps={{ value: "04-1234567" }}
          ...
          <InputSel
            label="負責人電話"
            inputProps={{ value: "0987654321" }}
            {...inputStyle02} />
          <InputSel
            label="工程地點"
            inputProps={{ value: "臺中市梧棲區經二路27號臺中市梧棲區經二路27號臺中市梧棲區經二路27號臺中市梧棲區經二路27號" }}
            {...inputStyle01} />
        </div>
      </div>
      ...
      <div className={style.rightBlock}>
        <InputSel
          label="工程編號"
          inputProps={{ value: "M-1101201" }}
          {...inputStyle01} />
        <InputSel
          label="承包商"
          inputProps={{ value: "創典科技A有限公司" }}
          {...inputStyle01} />
        <InputSel
          label="負責人"
          inputProps={{ value: "李先生" }}
          {...inputStyle01} />
        <InputSel
          label="公司電話"
          inputProps={{ value: "04-1234567" }}
