...
export default function
  useRemarkList(quotationData?: Tquotation) {
  let remarkListOri;
  if (quotationData) remarkListOri = quotationData.remarkList
  else remarkListOri = fakeEmptyRemark;
  ...
  const addRemarks = ((selRemark: Tremark[]) => {
    if (!selRemark[0]) return ModalInfo02({ title: "請選擇備註" })
