...
export default function QuotationPdf({
  ...
  const profilePram = (() => {
    ...
    const { quotationId, date: builtDate, constructionCounty, constructionDistrict, constructionAddress } = basicInfo;
    const { name: clientName, contact, fax } = clientProfile ?? {};
  ...
  const otherPram = (() => {
    ...
    const payInfo = (() => {
      const { tradingLocation, tradingDate, deposit, deliveryPayment, installedPayment, eleConnectPayment } =
