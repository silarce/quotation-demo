...
export default function Info({ prodAllData, quotationId }: { prodAllData: TInfo; quotationId: string }) {
  return (
...
const infoKeyIndex: TinfoKeyIndex[] = ['category', 'material', 'surface', 'doorType', 'size'];
