...
export const RotatingArrow01 = ({
  className = "", deg, isActive, defaultDeg
}:
  {
    className?: string
    deg: number
  ...
  const transform = `rotate(${isActive ? deg
  ...
  return (
    <svg className={className} style={theStyle} width="11" height="13" viewBox="0 0 11 13" fill="none" xmlns="http://www.w3.org/2000/svg">
