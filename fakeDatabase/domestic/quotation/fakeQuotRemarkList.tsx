...
type TremarkList = Tremark[];

const remarkOptions: Tremark[] = [
  ...
  { content: '備註一備註一備註一備註一' },
  { content: '備註二備註二備註二備註二備註二備註二備註二' },
];

const fakeQuotRemarkList: TremarkList = [
  { content: '防颱型捲門含防颱底座鎖固*1個、檔輪、鋁合金障感器及遙控器(1:2),捲箱2面0.8t。' },
  { content: '捲門烤漆色,採三久公司標準色(雲白/乳白),J-302門片1.5t色鋼捲(正反面不同色),若指定顏色單價另計' },
  {
    content:
...
export type { Tremark, TremarkList };
export { remarkOptions, fakeQuotRemarkList };
