...
interface TrecordProduct
  extends Omit<Tproduct, 'component' | 'accessory' | 'quoteType' | 'material' | 'surface' | 'doorRail' | 'memo'> {
  action: string;
  quoteType: string;
  material: string;
  surface: string;
...
const fakeChangeList: TchangeList = {
  'M-1110101-01': {
    ...
    product: [fakeProduct01, fakeProduct01, fakeProduct02],
  },
  'M-1110101-02': {
    id: 'M-1110101-02',
    date: '111-02-23',
    ...
    product: [fakeProduct01, fakeProduct01, fakeProduct01],
  },
  'M-1110101-03': {
    id: 'M-1110101-03',
    date: '111-02-25',
    ...
    product: [fakeProduct01, fakeProduct02, fakeProduct01],
  },
  'M-1110101-04': {
    id: 'M-1110101-04',
    date: '111-03-02',
    priceChange: 100000,
    remark: '備註備註備註備註備註',
    product: [fakeProduct02, fakeProduct01],
  },
  'M-1110101-05': {
    id: 'M-1110101-05',
    date: '111-03-15',
    priceChange: -100000,
    remark:
      '很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註很多備註',
    product: [fakeProduct02],
  },
};
...
export type { TprodChangingRecordList, TchangeRecord, TchangeListItem, TrecordProduct };
