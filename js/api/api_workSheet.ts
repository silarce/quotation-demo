...
export const useGetAnnotation_v2 =
  createUseApi_array_infinite({ apiClient: apiGetAnnotation, defaultParams: defaultParams_anno })
...
export const useGetQuotationRanges_v2 =
  createUseApi_array_infinite({ apiClient: apiGetQuotationRanges, defaultParams: defaultParams_qr })
